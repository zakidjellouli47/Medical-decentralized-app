<?php
 ...
 header("Access-Control-Allow-Origin: *");
    ...
    if(isset($obj["firstname"]) && isset($obj["lastname"]) && isset($obj["age"])&& isset($obj["role"])&& isset($obj["email"])&& isset($obj["pass"])  && isset($obj["ethereumAddress"])){
    ...
    $ethereumAddress = mysqli_real_escape_string($con,$obj['ethereumAddress']);
    ...
    if(isset($check)){
        ...
        // Echo the message on Screen.
         ...
         $Sql_Query = "insert into requests (firstname,lastname,age,role,email,pass,ethereumAddress) values ('$name','$last_name','$age','$role','$email','$password','$ethereumAddress')";
