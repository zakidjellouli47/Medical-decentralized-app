...
class TablePatient_doc extends StatefulWidget{
  ...
  const TablePatient_doc({super.key, required this.firstname, required this.lastname, required this.age, required this.email, required this.role, required this.pass, required this.ethereumAddress});
  ...
  @override
  _TablePatient_docState createState(){
    return _TablePatient_docState();
  }
}

class _TablePatient_docState extends State<TablePatient_doc> {
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            ...
            Navigator.push(context, MaterialPageRoute(builder: (context) => Dashboard_Doctor(firstname: widget.firstname,lastname: widget.lastname,age: widget.age,email: widget.email,ethereumAddress: widget.ethereumAddress,pass: widget.pass,role: widget.role,)));
          },
        ),
