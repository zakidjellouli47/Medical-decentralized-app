...
import 'package:med/screens/dashboard_patient_appointements.dart';
import 'package:med/screens/patient_records.dart';




import 'package:med/screens/table_appointments.dart';
...
class Dashboard_Patient extends StatefulWidget {
  ...
  const Dashboard_Patient ({super.key, required this.firstname, required this.lastname,required this.age, required this.email, required this.ethereumAddress, required this.pass, required this.role});

  @override
  State<Dashboard_Patient> createState() => _Dashboard_PatientState();
}

class _Dashboard_PatientState extends State<Dashboard_Patient> {
  static String profilePicLink = "";// first we make it null
...
//https://stackoverflow.com/questions/47124945/how-to-read-bytes-of-a-local-image-file-in-dart-flutter
    if (result != null) {
      ...
      // the package Uuid generates a random id for the file
                      ...
                      ElevatedButton(
                          onPressed: () {
                            ...
                            Navigator.of(context)
                                ...
                                builder: (context) =>  Dashboard_Patient(firstname:widget.firstname,lastname: widget.lastname,age: widget.age,email: widget.email,ethereumAddress: widget.ethereumAddress,role: widget.pass,pass: widget.pass,)));
                          },
                          child: const Text('ok'))
                    ],
                  ),
                      ...
                      ElevatedButton(
                          onPressed: () {
                            ...
                            Navigator.of(context)
                                .pushReplacement(MaterialPageRoute(
                                fullscreenDialog: true,
                                builder: (context) =>  PatientHomePage(firstname:widget.firstname,lastname: widget.lastname,age: widget.age,email: widget.email,ethereumAddress: widget.ethereumAddress,role: widget.pass,pass: widget.pass,)));
                          },
                          child: const Text('ok'))
                    ],
                  ),
        ...
        children:[
          ...
          icon: const Icon(Icons.home), onPressed: () {
                    Navigator.of(context)
                        .pushReplacement(MaterialPageRoute(
                        fullscreenDialog: true,
                        builder: (context) =>  Dashboard_Patient(firstname:widget.firstname,lastname: widget.lastname,age: widget.age,email: widget.email,ethereumAddress: widget.ethereumAddress,pass: widget.pass,role: widget.role,)));
                ...
                NavigationRailDestination(
                  ...
                  icon: IconButton(
                    ...
                    Navigator.of(context)
                        .pushReplacement(MaterialPageRoute(
                        fullscreenDialog: true,
                        builder: (context) =>  Dashboard_Patient_Appointements(firstname:widget.firstname,lastname: widget.lastname,age: widget.age,email: widget.email,ethereumAddress: widget.ethereumAddress,role: widget.role,pass: widget.pass,)));

                  },
                  ),

                  label: const Text("Appointements booking "),
                ...
                NavigationRailDestination(
                  icon:  IconButton(
                    ...
                    Navigator.of(context)
                        .pushReplacement(MaterialPageRoute(
                        fullscreenDialog: true,
                        builder: (context) => TableApp_patient(firstname:widget.firstname,lastname:widget.lastname,age: widget.age,email: widget.email,ethereumAddress: widget.ethereumAddress,role: widget.role,pass: widget.pass,)));
                ...
                NavigationRailDestination(
                  ...
                  icon: IconButton(
                    ...
                    Navigator.of(context)
                        .pushReplacement(MaterialPageRoute(
                        fullscreenDialog: true,
                        builder: (context) =>  WelcomeScreen_Patient(firstname: widget.firstname,lastname: widget.lastname,age: widget.age,email: widget.email,ethereumAddress: widget.ethereumAddress,pass: widget.pass,role: widget.role,)));
                    ...
                    showDialog(
                      ...
                      builder: (context) {
                        return AlertDialog(
                            ...
                            title: const Text('MetaMask information'),
                            ...
                            content: Form(
                              ...
                              child: Column(
                                mainAxisSize: MainAxisSize.min,// it means change according the texts
                                children: [
                  ...
                  children: [
                    ...
                    Center(
                      ...
                      SizedBox(// box of the image
                        ...
                        child: Image.asset('assets/cat.png',// image of the box
                        ),
                      ),
