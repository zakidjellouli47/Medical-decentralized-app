...
class GastroScreen extends StatelessWidget {
  ...
  const GastroScreen({super.key, required this.firstname, required this.lastname, required this.age, required this.role, required this.email, required this.pass, required this.ethereumAddress});
        ...
        children: [// children of the column
          MyHeader(// calling my header class
            ...
            child: Column(// calling the child widget of the header
              children: [
                MyAppbar(firstname: firstname,lastname: lastname,age: age,role: role,email: role,pass: pass,ethereumAddress: ethereumAddress),
                const SizedBox(// space between the appbar and userinfo
                  height: 10,// space with 10 px height
                ),
                UserInfo_Gastro (),// calling the userinfo class in order to get the doctor information
              ],
            ),
          ),
