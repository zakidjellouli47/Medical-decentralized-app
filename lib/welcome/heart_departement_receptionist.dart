...
import 'package:med/welcome/widget/user_info_heart_department.dart';


import 'package:med/widget/my_header.dart';

class HeartScreen_Rece extends StatelessWidget {
  ...
  const HeartScreen_Rece({super.key, required this.firstname, required this.lastname, required this.age, required this.role, required this.email, required this.pass, required this.ethereumAddress});
          ...
          MyHeader(// calling my header class
            ...
            child: Column(// calling the child widget of the header
              children: [
                ...
                const UserInfo_Heart(),// calling the userinfo class in order to get the doctor information
              ],
            ),
          ),
