...
class ReserveScreen_Patient extends StatelessWidget {
  ...
  const  ReserveScreen_Patient({super.key, required this.firstname, required this.lastname, required this.age, required this.role, required this.email, required this.pass, required this.ethereumAddress});
        ...
        children: [// children of the column
          MyHeader(// calling my header class
            ...
            child: Column(// calling the child widget of the header
              children: [
                MyAppbar_Patient(firstname: firstname,lastname: lastname,age: age,role: role,email: email,pass: pass,ethereumAddress: ethereumAddress),
