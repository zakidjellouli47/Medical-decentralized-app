...
import 'package:med/welcome/gastrology_receptionist.dart';
import 'package:med/welcome/heart_departement_receptionist.dart';
import 'package:med/welcome/reserve_screen_receptionist.dart';
...
import '../screens/dashboard_receptionist.dart';

class WelcomeScreen_Rece extends StatelessWidget {
  ...
  const WelcomeScreen_Rece({super.key, required this.firstname, required this.lastname, required this.age, required this.role, required this.email, required this.pass, required this.ethereumAddress});
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            ...
            Navigator.push(context, MaterialPageRoute(builder: (context) =>  Dashboard_Receptionist(firstname: firstname,lastname: lastname,age: age,role: role,email: email,pass: pass,ethereumAddress: ethereumAddress,)));
          },
        ),
      ),
                                ...
                                ElevatedButton(
                                    onPressed: () {
                                      ...
                                      Navigator.of(context)
                                          ...
                                          builder: (context) =>  ReserveScreen_rece(firstname: firstname,lastname: lastname,age: age,role: role,email:email,pass: pass,ethereumAddress: ethereumAddress)));
                                    },
                                    child: const Text('ok'))
                              ],
                            ),
                                ...
                                ElevatedButton(
                                    onPressed: () {
                                      ...
                                      Navigator.of(context)
                                          .pushReplacement(MaterialPageRoute(
                                          fullscreenDialog: true,
                                          builder: (context) =>  GastroScreen_rece(firstname: firstname,lastname: lastname,age: age,role: role,email: email,pass: pass,ethereumAddress: ethereumAddress,)));
                                    },
                                    child: const Text('ok'))
                              ],
                            ),
                                ...
                                ElevatedButton(
                                    onPressed: () {
                                      ...
                                      Navigator.of(context)
                                          .pushReplacement(MaterialPageRoute(
                                          fullscreenDialog: true,
                                          builder: (context) =>  HeartScreen_Rece(firstname: firstname,lastname: lastname,age: age,role: role,email: email,pass: pass,ethereumAddress: ethereumAddress,)));
                                    },
                                    child: const Text('ok'))
                              ],
                            ),
