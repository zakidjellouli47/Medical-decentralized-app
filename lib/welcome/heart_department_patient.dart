...
class HeartScreen_Patient extends StatelessWidget {
  ...
  const HeartScreen_Patient({super.key, required this.firstname, required this.lastname, required this.age, required this.role, required this.email, required this.pass, required this.ethereumAddress});
          ...
          MyHeader(// calling my header class
            ...
            child: Column(// calling the child widget of the header
              children: [
                ...
                UserInfo_Heart(),// calling the userinfo class in order to get the doctor information
              ],
            ),
          ),
