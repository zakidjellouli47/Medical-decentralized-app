...
import 'package:med/welcome/gastrology.dart';
import 'package:med/welcome/heart_department.dart';
import 'package:med/welcome/reserve_screen.dart';
...
class WelcomeScreen extends StatelessWidget {
  ...
  const WelcomeScreen({super.key, required this.firstname, required this.lastname, required this.age, required this.role, required this.email, required this.pass, required this.ethereumAddress});



  @override
  Widget build(BuildContext context) {
    return Scaffold(// scaffold that builds the app screen

      appBar: AppBar(// app bar inside the scaffold

        backgroundColor: Colors.redAccent, //background color of app bar
        elevation: 5,// to make the ui more bright and have some blury shadows
        leading: IconButton(
          icon: const Icon(Icons.arrow_back, color: Colors.black54),// going back the admin home menu
          onPressed: () {
            // passing this to our root
            Navigator.push(context, MaterialPageRoute(builder: (context) =>  Dashboard_Admin(firstname: firstname,lastname: lastname,age: age,role: role,email: email,pass: pass,ethereumAddress: ethereumAddress,)));
          },
        ),
      ),
                                ...
                                ElevatedButton(
                                    onPressed: () {
                                      ...
                                      Navigator.of(context)
                                          ...
                                          builder: (context) =>  ReserveScreen(firstname: firstname,lastname: lastname,age: age,role: role,email:email,pass: pass,ethereumAddress: ethereumAddress)));
                                    },
                                    child: const Text('ok'))
                              ],
                            ),
                                ...
                                ElevatedButton(
                                    onPressed: () {
                                      ...
                                      Navigator.of(context)
                                          .pushReplacement(MaterialPageRoute(
                                          fullscreenDialog: true,
                                          builder: (context) =>  GastroScreen(firstname: firstname,lastname: lastname,age: age,role: role,email: email,pass: pass,ethereumAddress: ethereumAddress,)));
                                    },
                                    child: const Text('ok'))
                              ],
                            ),
                                ...
                                ElevatedButton(
                                    onPressed: () {
                                      ...
                                      Navigator.of(context)
                                          .pushReplacement(MaterialPageRoute(
                                          fullscreenDialog: true,
                                          builder: (context) =>  HeartScreen(firstname: firstname,lastname: lastname,age: age,role: role,email: email,pass: pass,ethereumAddress: ethereumAddress,)));
                                    },
                                    child: const Text('ok'))
                              ],
                            ),
