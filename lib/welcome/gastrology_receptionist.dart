...
class GastroScreen_rece extends StatelessWidget {
  ...
  const GastroScreen_rece({super.key, required this.firstname, required this.lastname, required this.age, required this.role, required this.email, required this.pass, required this.ethereumAddress});
        ...
        children: [// children of the column
          MyHeader(// calling my header class
            ...
            child: Column(// calling the child widget of the header
              children: [
                MyAppbar_rece(firstname: firstname,lastname: lastname,age: age,role: role,email: role,pass: pass,ethereumAddress: ethereumAddress),
