...
class RecoverPassword_dir extends StatefulWidget {
  ...
  const RecoverPassword_dir({super.key,required this.firstname, required this.lastname,  required this.role, required this.pass, required this.UID});



  @override
  State<RecoverPassword_dir> createState() => _RecoverPassword_dirState();
}
class _RecoverPassword_dirState extends State<RecoverPassword_dir> {
