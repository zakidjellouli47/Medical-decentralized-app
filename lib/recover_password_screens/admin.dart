...
class RecoverPassword extends StatefulWidget {
  ...
  const RecoverPassword({super.key,required this.firstname, required this.lastname,  required this.role, required this.pass, required this.UID});
                  ...
                  ElevatedButton(
                      onPressed: () {
                        ...
                        Navigator.of(context)
                            ...
                            builder: (context) =>  RecoverPassword(firstname: widget.firstname,lastname: widget.lastname,pass: widget.pass,role: widget.role,UID: widget.UID,)));
                      },
                      child: const Text('ok'))
                ],
              ),
                ...
                Column(
                  children: <Widget>[
                    ...
                    const SizedBox(
                     ...
                     Text(
                      "Reset your password now,Mr. ${widget.lastname} ${widget.firstname}",
