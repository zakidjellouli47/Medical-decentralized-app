...
class RecoverPassword_d extends StatefulWidget {
  ...
  const RecoverPassword_d({super.key,required this.firstname, required this.lastname,  required this.role, required this.pass, required this.UID});



  @override
  State<RecoverPassword_d> createState() => _RecoverPassword_dState();
}
class _RecoverPassword_dState extends State<RecoverPassword_d> {
